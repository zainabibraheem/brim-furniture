    ...
    <nav >
      ...
      <div className='lg:flex w-full bg-[#ffffff] items-center text-gray-6600 justify-between flex-wrap  py-3 px-10 hidden '>
        ...
        <div>
          ...
          <Link className='text-xl mr-10' to='/'>Home</Link>
          <Link className='text-xl mr-10' to='shop'>Shop</Link>
          <Link className='text-xl mr-10' to='aboutpage'>About</Link>
          <Link className='text-xl mr-10' to='contact'>Contact</Link>
        ...
        <div className='flex gap-10 items-center'>
          <div className='flex items-center mr-20 gap-2 border border-black p-[2px] rounded-3xl'>
            ...
            <input className='bg-transparent text-gray-700' placeholder='search...' />
          </div>
      ...
      <div className='flex w-full bg-[#ffffff] items-center text-gray-6600 justify-between flex-wrap lg:hidden  py-3 px-10'>
       ...
       {toggledNav && (
         ...
         <div className='flex items-center mr-20 justify-between border-b w-full border-gray-300 mb-5 p-[3px]'>
          
           <input className='bg-transparent text-gray-900 ml-3'placeholder='search for product' />
           <MdSearch className='mr-3' size={22} />
         </div>

         <div className='flex flex-col gap-5  text-lg'>
           <Link className='border-b border-gray-300' to='/'
             onClick={() => (setToggledNav(false))}
           >
            <h2 className='ml-3 pb-4'>Home</h2>
           </Link>

           <Link className='border-b border-gray-300' to='shop'
            onClick={() => (setToggledNav(false))}
           >
             <h2 className='ml-3 pb-4'>Shop</h2>
           </Link>

           <Link className='border-b border-gray-300' to='aboutpage'
            onClick={() => (setToggledNav(false))}
           >
             <h2 className='ml-3 pb-4'>About</h2>
           </Link>

           <Link className='border-b border-gray-300' to='contact'
            onClick={() => (setToggledNav(false))}
           >
