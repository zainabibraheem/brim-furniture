...
const BestsellerDetails = () => {
    ...
    useEffect(() => {
        ...
        const newBestSeller = bestsellerData.find(product => product.id === newId)
        setSelectedProduct(newBestSeller);
    ...
    if (!selectedProduct) {
        return <h2 className='text-3xl text-center p-10'>Loading...</h2>
    }
